...
const copy = {
  en: {
    ...
    endpoints: 'Monitored endpoints', telemetry: 'Telemetry collection', siem: 'SIEM & detection', firewall: 'FortiGate perimeter firewall',
  ...
  ar: {
    ...
    endpoints: 'الأجهزة المراقبة', telemetry: 'جمع البيانات', siem: 'SIEM والاكتشاف', firewall: 'الجدار الناري FortiGate',
